...
var __vue_render__$9 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<span class=\"p-student_survey_solid\" data-v-85f9c6f8></span> <header data-v-85f9c6f8><h3 data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(_vm.state.myData.category) + "の調査結果") + "</h3></header> "), _vm._ssrNode("<div class=\"p-student_survey_body\" data-v-85f9c6f8>", "</div>", [_vm._ssrNode("<div class=\"p-student_survey_summary\" data-v-85f9c6f8>", "</div>", [_vm._ssrNode("<div class=\"p-student_survey_result_box\" data-v-85f9c6f8>", "</div>", [_vm._ssrNode("<div class=\"p-student_survey_result\" data-v-85f9c6f8>", "</div>", [_c('app-compilation-icon', {
    attrs: {
  ...
  }), _vm._ssrNode(" <p class=\"p-student_survey_score\" data-v-85f9c6f8>" + _vm._ssrEscape("\n            " + _vm._s(_vm.state.myData.summary.value) + "\n          ") + "</p> "), _c('app-change-tag', {
    attrs: {
      "change": _vm.state.myData.summary.change
    }
  })], 2), _vm._ssrNode(" <div class=\"p-student_survey_content\" data-v-85f9c6f8><p data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(_vm.state.myData.outline)) + "</p></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"p-student_survey_result_graph\" data-v-85f9c6f8>", "</div>", [_c('line-chart', {
    attrs: {
      "chart-data": _vm.state.myData.summaryData,
      "options": _vm.state.options,
      "height": _vm.state.height
    }
  })], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"p-student_survey_detail\" data-v-85f9c6f8>", "</div>", [!_vm.state.isMobile ? [_vm._ssrNode("<ul class=\"p-student_detail_list\" data-v-85f9c6f8>", "</ul>", _vm._l(_vm.state.myData.details.data, function (text, index) {
    return _vm._ssrNode("<li" + _vm._ssrClass(null, {
      'is-select': _vm.state.myData.selectDetailIndex === index
    }) + " data-v-85f9c6f8>", "</li>", [_vm._ssrNode("<p class=\"p-student_detail_result\" data-v-85f9c6f8>" + _vm._ssrEscape("\n              " + _vm._s(_vm.state.myData.feature[text.label].summary.value) + "\n            ") + "</p> "), _c('app-change-tag', {
      attrs: {
        "change": _vm.state.myData.feature[text.label].summary.change
      }
    }), _vm._ssrNode(" <p class=\"p-student_detail_label\" data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(text.value)) + "</p>")], 2);
  }), 0), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"p-student_detail_graph\" data-v-85f9c6f8>", "</div>", [_vm._ssrNode("<h4 data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(_vm.state.myData.details.intro.title)) + "</h4> <p data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(_vm.state.myData.details.intro.text)) + "</p> "), _c('line-chart', {
    attrs: {
      "chart-data": _vm.state.myData.detailData,
      "options": _vm.state.options,
      "height": _vm.state.height
    }
  })], 2)] : [_vm._ssrNode("<ul class=\"p-student_detail_accordion_list\" data-v-85f9c6f8>", "</ul>", _vm._l(_vm.state.myData.details.data, function (text, index) {
    return _vm._ssrNode("<li data-v-85f9c6f8>", "</li>", [_vm._ssrNode("<button type=\"button\"" + _vm._ssrClass(null, {
      'is-active': _vm.state.myData.selectDetailIndex === index
    }) + " data-v-85f9c6f8>", "</button>", [_vm._ssrNode("<div class=\"p-student_detail_info\" data-v-85f9c6f8>", "</div>", [_vm._ssrNode("<p class=\"p-student_detail_result\" data-v-85f9c6f8>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.state.myData.feature[text.label].summary.value) + "\n                ") + "</p> "), _c('app-change-tag', {
      attrs: {
        "change": _vm.state.myData.feature[text.label].summary.change
      }
    }), _vm._ssrNode(" <p class=\"p-student_detail_label\" data-v-85f9c6f8>" + _vm._ssrEscape(_vm._s(text.value)) + "</p>")], 2), _vm._ssrNode(" "), _c('icon-cheveron')], 2), _vm._ssrNode(" "), _c('transition', {
      attrs: {
        "name": "detail"
      },
      on: {
...
var __vue_inject_styles__$a = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-85f9c6f8_0", {
    source: ".m-student_survey_graph[data-v-85f9c6f8]{margin-top:2rem;background:#fff;border-radius:5px;border:1px solid #e1ebeb}@media screen and (max-width:768px){.m-student_survey_graph[data-v-85f9c6f8]{margin:2rem 0 0}}.m-student_survey_graph.is-selEq .p-student_survey_solid[data-v-85f9c6f8]{background:#00abff}@media screen and (max-width:768px){.m-student_survey_graph.is-selEq header[data-v-85f9c6f8]{background:#00abff}}.m-student_survey_graph.is-grit .p-student_survey_solid[data-v-85f9c6f8]{background:#bf6be6}@media screen and (max-width:768px){.m-student_survey_graph.is-grit header[data-v-85f9c6f8]{background:#bf6be6}}.m-student_survey_graph.is-motivation .p-student_survey_solid[data-v-85f9c6f8]{background:#00c09e}@media screen and (max-width:768px){.m-student_survey_graph.is-motivation header[data-v-85f9c6f8]{background:#00c09e}}.m-student_survey_graph.is-deviation .p-student_survey_solid[data-v-85f9c6f8]{background:#015593}@media screen and (max-width:768px){.m-student_survey_graph.is-deviation header[data-v-85f9c6f8]{background:#015593}}.p-student_survey_solid[data-v-85f9c6f8]{display:block;height:.5rem;border-radius:5px 5px 0 0}@media screen and (max-width:768px){.p-student_survey_solid[data-v-85f9c6f8]{display:none}}header[data-v-85f9c6f8]{padding:1.55rem 2rem;font-size:1.6rem;font-weight:700;border-bottom:1px solid #e1ebeb}@media screen and (max-width:768px){header[data-v-85f9c6f8]{padding:1.2rem 2rem;color:#fff;border-radius:5px 5px 0 0;border-bottom:none}}.p-student_survey_summary[data-v-85f9c6f8]{display:flex;justify-content:space-between;align-items:flex-start;padding:2rem 3rem;border-bottom:1px solid #e1ebeb}@media screen and (max-width:768px){.p-student_survey_summary[data-v-85f9c6f8]{display:block;padding:2rem}}.p-student_survey_result[data-v-85f9c6f8]{font-size:0}.p-student_survey_result>div[data-v-85f9c6f8],.p-student_survey_result>p[data-v-85f9c6f8]{display:inline-block;vertical-align:middle}.p-student_survey_score[data-v-85f9c6f8]{padding-left:2rem;font-size:3.2rem;font-weight:700}@media screen and (max-width:768px){.m-survey_change_tag[data-v-85f9c6f8]{margin-left:1rem}}.p-student_survey_content[data-v-85f9c6f8]{padding-top:1.6rem}.p-student_survey_content p[data-v-85f9c6f8]{font-size:1.2rem;line-height:1.8}.p-student_survey_result_graph[data-v-85f9c6f8]{width:43.2rem}@media screen and (max-width:768px){.p-student_survey_result_graph[data-v-85f9c6f8]{width:100%}}.p-student_survey_detail[data-v-85f9c6f8]{display:flex;justify-content:space-between}@media screen and (max-width:768px){.p-student_survey_detail[data-v-85f9c6f8]{display:block}}.p-student_detail_list[data-v-85f9c6f8]{position:relative;width:calc(100% - 47rem);border-right:1px solid #e1ebeb}.p-student_detail_list li[data-v-85f9c6f8]{cursor:pointer;position:relative;padding:1rem 3rem;font-size:0;transition:all .6s cubic-bezier(.77,0,.175,1)}.p-student_detail_list li p[data-v-85f9c6f8]{display:inline-block;vertical-align:middle;transition:all .6s cubic-bezier(.77,0,.175,1)}.p-student_detail_list li[data-v-85f9c6f8]:hover{background:#f9fbfb}.p-student_detail_list li:hover .p-student_detail_result[data-v-85f9c6f8]{color:#00abff}.p-student_detail_list li:hover .p-student_detail_label[data-v-85f9c6f8]{color:#00abff}.p-student_detail_list li.is-select[data-v-85f9c6f8]::before{content:\"\";display:block;position:absolute;top:0;right:0;width:.5rem;height:100%;background:#00abff}.p-student_detail_list li.is-select[data-v-85f9c6f8]::after{content:\"\";display:block;position:absolute;top:50%;right:-1.2rem;transform:translate(0,-50%);width:0;height:0;border-top:solid .6rem transparent;border-right:solid .6rem transparent;border-bottom:solid .6rem transparent;border-left:solid .6rem #00abff}.p-student_detail_accordion_list li[data-v-85f9c6f8]{border-bottom:1px solid #e1ebeb}.p-student_detail_accordion_list button[data-v-85f9c6f8]{display:flex;justify-content:space-between;align-items:center;padding:2.2rem 2rem;width:100%}.p-student_detail_accordion_list button svg[data-v-85f9c6f8]{transition:all .6s cubic-bezier(.77,0,.175,1)}.p-student_detail_accordion_list button.is-active svg[data-v-85f9c6f8]{transform:rotate(-90deg)}.p-student_detail_info[data-v-85f9c6f8]{display:flex;justify-content:flex-start;align-items:center;width:calc(100% - 2.4rem)}.p-student_detail_info .m-survey_change_tag[data-v-85f9c6f8]{margin-left:1.6rem}.p-student_detail_area[data-v-85f9c6f8]{padding:0 2rem 2rem}.p-student_detail_area p[data-v-85f9c6f8]{padding-bottom:1.5rem;font-size:1.2rem;line-height:1.5}.p-student_detail_area .p-student_detail_graph_area[data-v-85f9c6f8]{width:100%}.p-student_detail_result[data-v-85f9c6f8]{padding-right:.6rem;font-size:2.4rem;font-weight:700}.p-student_detail_label[data-v-85f9c6f8]{padding-left:1.2rem;font-size:1.4rem;font-weight:700}@media screen and (max-width:768px){.p-student_detail_label[data-v-85f9c6f8]{font-size:1.6rem}}.p-student_detail_graph[data-v-85f9c6f8]{padding:2.4rem 2rem;width:47rem}.p-student_detail_graph h4[data-v-85f9c6f8]{padding-bottom:1.4rem;font-size:1.6rem;font-weight:700}.p-student_detail_graph p[data-v-85f9c6f8]{padding-bottom:2rem;font-size:1.2rem;line-height:1.5}.detail-enter-active[data-v-85f9c6f8],.detail-leave-active[data-v-85f9c6f8]{transition:height .4s ease}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__$a = "data-v-85f9c6f8";
/* module identifier */

var __vue_module_identifier__$a = "data-v-85f9c6f8";
/* functional template */
